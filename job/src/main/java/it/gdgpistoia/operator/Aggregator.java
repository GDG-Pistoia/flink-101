...
public class Aggregator extends RichCoFlatMapFunction<Tuple2<String, Status>, Tuple3<String, String, String>,
        Tuple3<String, Set<String>, Statistic>> {

    private static final long serialVersionUID = -8175374779700514533L;
    //state
